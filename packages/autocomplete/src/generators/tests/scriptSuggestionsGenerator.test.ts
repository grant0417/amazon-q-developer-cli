import * as apiBindingsWrappers from "@aws/amazon-q-developer-clapi-bindings-wrappers/executeCommand";
...
vi.mock(
  "@aws/amazon-q-developer-clapi-bindings-wrappers/src/executeCommand",
  async () =>
    vi.importActual(
      "@aws/amazon-q-developer-clapi-bindings-wrappers/src/executeCommand",
    ),
